...
map.set("n", "<C-right>", "<C-w>>", { desc = "Move focus to left window" })
map.set("n", "<C-left>", "<C-w><", { desc = "Move focus to right window" })
map.set("n", "<C-up>", "<C-w>+", { desc = "Move focus to lower window" })
map.set("n", "<C-down>", "<C-w>-", { desc = "Move focus to upper window" })
