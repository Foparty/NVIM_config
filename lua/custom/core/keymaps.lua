...
map.set("n", "<C-a>", "gg<S-v>G", { desc = "Select all text" })
...
map.set("n", "<C-]>", "<cmd>cnext<CR>", { desc = "Go to next quickfix item" })
map.set("n", "<C-[>", "<cmd>cprev<CR>", { desc = "Go to previous quickfix item" })
...
map.set("n", "<leader>nh", "<cmd>Noice<cr>", { desc = "Notification History" })
